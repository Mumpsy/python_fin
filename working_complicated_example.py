...
def create_ctrl_panel(win):
    ...
    [panel.symbol.addItem(i) for i in 'QQQ MSFT TSLA TSM AAPL AMZN'.split()]
    ...
    [panel.interval.addItem(i) for i in '1d 4h 1h 30m 15m 5m'.split()] #can't use 1m for 1mo period, cant use 1d 4h for 5d period
